...
use SIS\AdminBundle\Entity\Role;
use SIS\AdminBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SISAdminBundle:Role')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SISAdminBundle:Role')->find($id);
     ...
     * @Method("post")
     * @Template("SISAdminBundle:Role:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("SISAdminBundle:Role:edit.html.twig")
     */
